...
export interface GroupSetting {
  ...
  share_root_id?: number;
  share_root_owner?: number;
}
...
export interface UpsertGroupService {
  group: GroupEnt;
  // Hashid of the user to set as the group share root owner. Decoded server-side.
  // undefined = leave unchanged, "" = clear the owner.
  share_root_owner_hash?: string;
}
